...
export function AboutPage() {
  return (
    <InfoPage
      ...
      description="StroyRayon - курулуш материалдарын, инженердик сантехниканы, электриканы, шаймандарды жана вентиляция товарларын WhatsApp аркылуу тез тактап буйрутма берүүгө жардам берген онлайн каталог."
      canonicalPath="/about"
    >
      <section className="info-grid">
        ...
        <article>
          <h2>Кантип буйрутма берилет</h2>
          <p>
            Каталогдон товар тандап себетке кошосуз. Буйрутма берүү барагынан байланыш маалыматтарын жазып, буйрутманы WhatsApp
...
export function PaymentPage() {
  return (
    <InfoPage
      ...
      description="StroyRayon буйрутмалары боюнча төлөм товар, көлөм жана жеткирүү шарты менеджер менен такталгандан кийин кабыл алынат."
    ...
    >
      <section className="info-grid">
        ...
        <article>
          ...
          <p>Банктык тиркеме же карта аркылуу которуу мүмкүн. Реквизиттер буйрутма такталгандан кийин WhatsApp аркылуу берилет.</p>
        </article>
        <article>
          <h2>Документ жана чек</h2>
          <p>Ири көлөмдөгү буйрутмалар боюнча документ керек болсо, менеджерге алдын ала айтып коюңуз.</p>
        </article>
        <article>
          <h2>Маанилүү</h2>
          <p>{priceStockDisclaimer}</p>
    ...
    >
      <section className="info-grid">
        ...
        <article>
          ...
          <p>Кемчилик байкалса, товар сүрөтүн жана буйрутма маалыматын WhatsApp аркылуу жөнөтүңүз. Менеджер чечүү жолун сунуштайт.</p>
        </article>
        <ContactCard />
      </section>
    </InfoPage>
...
export function PrivacyPage() {
  return (
    <InfoPage
      ...
      description="StroyRayon сайтында калтырган байланыш маалыматтары буйрутманы тактоо, жеткирүү шартын сүйлөшүү жана кардар менен байланышуу үчүн гана колдонулат."
      canonicalPath="/privacy"
    >
      <section className="info-grid">
        <article>
          <h2>Кандай маалымат алынат</h2>
          <p>Буйрутма берүү формасында аты-жөнүңүз, телефон номериңиз, дарек же аймак жана кошумча маалымат кабыл алынат.</p>
        </article>
        <article>
          <h2>Маалымат эмне үчүн керек</h2>
          <p>Бул маалымат буйрутманын курамын, бааны, товар бар-жогун жана жеткирүү шартын WhatsApp аркылуу тактоо үчүн колдонулат.</p>
        </article>
        <article>
          <h2>Үчүнчү жактар</h2>
          <p>Маалымат товар жеткирүү же буйрутманы аткаруу үчүн зарыл учурларды эске албаганда сыртка берилбейт.</p>
        </article>
        <article>
          <h2>Байланыш</h2>
          <p>{commonContactText}</p>
