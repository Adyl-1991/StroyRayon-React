...
const routes = [
  ...
  { path: '/catalog/stroymaterial', kg: 'Курулуш материалдары', ru: 'Стройматериалы' },
  { path: '/catalog/stroymaterial/kurgak-aralashmalar/shtukaturkalar', kg: null, ru: null },
  ...
  { path: '/catalog/instrument', kg: 'Шаймандар', ru: 'Инструменты' },
  { path: '/catalog/krepezh', kg: 'Бекиткич', ru: 'Крепёж' },
  ...
  { path: '/product/alinex-stukaturka-dlia-dekorativnoi-otdelki-munfort-f-35', kg: null, ru: null },
